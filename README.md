...
```bash
git clone https://github.com/matt3r-ai/DD3D.git
cd dd3d
...
### Evaluation
make docker-build
make docker-run COMMAND="./scripts/train.py +experiments=matter_benchmark.yaml EVAL_ONLY=True TEST.IMS_PER_BATCH=4"

### Fine tuning on City Scapes
make docker-run COMMAND="./scripts/train.py +experiments=cityscapes_test.yaml TEST.IMS_PER_BATCH=4"
./scripts/train.py +experiments=cityscapes_test.yaml TEST.IMS_PER_BATCH=4
...
This is a fork version of TRI-DD3D.
