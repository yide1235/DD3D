...
from tridet.data.datasets.matt3r import register_matt3r_datasets
from tridet.data.datasets.cityscapes import register_cityscapes_dataset
...
def register_datasets(cfg):
    ...
    dataset_names.extend(register_matt3r_datasets(required_datasets, cfg))
    dataset_names.extend(register_cityscapes_dataset(required_datasets, cfg))
