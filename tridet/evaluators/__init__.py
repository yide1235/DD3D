...
from tridet.evaluators.matt3r_evaluator import MatterEvaluator
from tridet.utils.comm import is_distributed

LOG = logging.getLogger('tridet')

AVAILABLE_EVALUATORS = ["coco_evaluator", "kitti3d_evaluator", "nuscenes_evaluator", "matt3r_evaluator", "cityscapes_evaluator"]
...
def get_evaluator(cfg, dataset_name, evaluator_name, output_dir):
    ...
    elif evaluator_name == "matt3r_evaluator":
        return MatterEvaluator(output_dir=output_dir,dataset_name=dataset_name)
    
    # TODO: Change to CityScapes evaluator
    elif evaluator_name == "cityscapes_evaluator":
        return MatterEvaluator(output_dir=output_dir,dataset_name=dataset_name)
